package com.leftcoding.app.todo.dialog;
...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public interface EditingTaskListener {
        void onTaskEdited(TaskModel updatedTask);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TaskModel task = new TaskModel(title, date, priority, 0, timeStamp);
        ...
        if (etTitle != null) {
            etTitle.setSelection(etTitle != null ? etTitle.length() : 0);
        }
        if (task.getDate() != 0) {
            if (etDate != null) {
        ...
        builder.setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                task.setStatus(TaskModel.STATUS_CURRENT);
                if (etDate.length() != 0 || etTime.length() != 0) {
